...
import { FaPlus, FaEnvelope, FaFileExcel, FaChevronDown, FaUsers } from "react-icons/fa"
...
function Attendees() {
  ...
  return (
    <Dropdown title={"Attendees"} description="Manage your event attendees" icon={<FaUsers />}>
              ...
              <tbody>
                {attendeesData.length === 0 ? (
                  ...
                  attendeesData.map((attendee) => (
                    <tr key={attendee.id} className="border-b border-gray-800 hover:bg-gray-900">
                      <td className="p-3">
                        <input
                          type="checkbox"
